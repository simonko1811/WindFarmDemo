...
public class WindFarmDemoApplication extends Application<WindFarmDemoConfiguration> {
     ...
     */
    private final HibernateBundle<WindFarmDemoConfiguration> hibernate = new HibernateBundle<WindFarmDemoConfiguration>(User.class, Person.class, Phone.class, Senzor_data.class) {
    ...
    private void registerResources(WindFarmDemoConfiguration configuration, Environment environment) {
        ...
        final SenzorDataDao senzorDataDao = new SenzorDataDao(hibernate.getSessionFactory());
        ...
        final SenzorDataResource senzorDataResource = new SenzorDataResource(senzorDataDao);

        environment.jersey().register(helloWorldResource);
        environment.jersey().register(loginResource);
        environment.jersey().register(usersResource);
        environment.jersey().register(personResource);
        environment.jersey().register(senzorDataResource);
    }
